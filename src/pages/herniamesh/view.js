...
// ** API Imports
import { viewHerniamesh } from "src/store/herniamesh";
...
const defaultValues = {
  email: "",
  is_herniamesh_implanted_in_2010_or_later: "",
  last_name: "",
  phone: "",
  zip: "",
  first_name: "",
  is_meshfail_requiring_revision_or_removal: "",

  ip_address: "",
};

const HerniameshView = ({ id }) => {
  ...
  useEffect(() => {
    (async () => {
      setWait(true);
      await dispatch(viewHerniamesh(id)).then((response) => {
  ...
  if (wait) {
    ...
    return (
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <ViewTitle sx={{ textAlign: "center" }}>Herniamesh View</ViewTitle>
            <Divider />
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <Grid container spacing={5}>
                  ...
                  <Grid item xs={12} sm={6}>
                    <FormControl>
                      <FormLabel>
                        Did you have your hernia mesh implanted in 2010 or
                        later?
                      </FormLabel>
                      <Controller
                  ...
                  <Grid item xs={12} sm={6}>
                    <FormControl>
                      <FormLabel>
                        Did your mesh fail requiring removal or revision?
                      </FormLabel>
                      <Controller
